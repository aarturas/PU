@extends('layouts.app')
@section('content')
                               <h6 style="padding-left:40%">index.blade.paskaitos</h6>
...
<div class="col-md-9">
   {{--                                                       Pasirenkame grupes id, ir kurso pavadinima                                                                     --}}
        <a href="{{route('paskaito.show', $paskaito)}}" class="list-group-item list-group-item-action list-group-item-primary">{{$paskaito->grupe_id}} Kursas : {{$paskaito->pavadinimas}}</a>
</div>
