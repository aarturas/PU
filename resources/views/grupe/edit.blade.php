...
@section('content')
                     ...
                     <h3 class="text-center">Grupės redagavimas</h3>
<div class="container">
...
<small class="form-text text-muted">Prašom pasirinkti paskaitą.</small>
 ...
 {{--  -------------------------    2.  Redaguojame paskaitas  ---------------------------------------------------------                       --}}

 <div class="form-group">
        <label for="pavadinimas" > Patikslintas grupės pavadinimas</label>
        <input type="text" class="form-control" name="pavadinimas" id="pavadinimas" aria-describedby="emailHelp" placeholder="Grupės pavadinimas" value="{{old('pavadinimas', $grupe->pavadinimas)}}">
        <small class="form-text text-muted">Paskaitų pavadinimas</small>
</div>

{{--    --------------------        3.  Pasirenkame dėstytoją (1) arba studentą (2) su select'u ir "where"  -----------------------         --}}
...
<div class="form-group">
        <label for="started_at">Grupės mokymų pradžia</label>
...
<div class="form-group">
        <label for="finished_at">Grupės mokymų pabaiga</label>
