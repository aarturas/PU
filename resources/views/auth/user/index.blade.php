...
<h4 style="padding-left:30%">index.blade.vartotojai</h4>
<h3 style="padding-left:20%">vartotojų redagavimas</h3>
                                              @section('content')
<div class="container">
...
<div class="list-group">
                                              @foreach ($collection as $vartotojai)
<div class="row" style="margin-bottom: 10px;">
<div class="col-md-9">
                        <a href="{{route('vartotojai.show', $vartotojai)}}" class="list-group-item list-group-item-action list-group-item-primary">{{$vartotojai->name}} Kursai: {{$vartotojai->showKursai->pavadinimas}}</a>
</div>

<div class="col-md-3" style="display:flex; justify-content:space-around; align-items:center;">

                        <a href="{{route('vartotojai.edit', $vartotojai)}}">
        ...
        <form action="{{route('vartotojai.destroy', $vartotojai)}}" method="POST">
                            @csrf
